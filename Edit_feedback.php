...
<div id="contact-form">
    <div>
      ...
      <!-- <h4>Enter your Feedback and click Update!!!</h4>  -->
        ...
        <input type="number" id="stud_knowl" name="std_knowledge" required="required" tabindex="1" autofocus="autofocus"/>
        </label>    

        <label for= "stud_behaviour">
        <span class="required">Enter Rating for student Behaviour(Out of 5.0): *</span>
        <input type="number"  id="stud_behaviour" name="std_behaviour" required="required" tabindex="1" autofocus="autofocus"/>
        </label>  
    
        <label for= "over_rat">
        <span class="required">Enter Your Overall Placement Experience(Out of 5.0): *</span>
        <input type="number"  id="over_rat" name="overall_rating" required="required" tabindex="1" autofocus="autofocus"/>
        </label>  
        </div>  
    ...
    if(isset($_POST['submitedit']))
    {
        ...
        $update = "INSERT INTO FEEDBACK VALUES(NULL,$cmp_id,'$message',$stu_know,$std_behaviour,$overall)";
